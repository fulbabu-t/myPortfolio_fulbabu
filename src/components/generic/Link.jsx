...
function Link({
    ...
    const hrefClass = !href ? "link-no-href" : ""
    ...
    const _open = () => {
        ...
        // ==========================================
        // GITHUB - OPEN DIRECTLY IN NEW TAB
        // ==========================================
        ...
        // YouTube
            ...
            href.includes("youtube.com/watch?v=")
        ) {
            _openYoutubeLink()
        }
    ...
    const _openYoutubeLink = () => {
        feedbacks.displayYoutubeVideo(
            href,
            metadata?.title ||
                language.getString("watch_video"),
    ...
    const _openExternalLink = () => {
        ...
        const shortenedHref =
            utils.string.limitTextSize(href, 45)

        const formattedUrl =
            `<br><span class="text-secondary">« <b>${shortenedHref}</b> »</span><br><br>`

        const text =
            language
                .getString("leaving_site")
                .replace("{url}", formattedUrl) +
